...
namespace Photon.Chat.UtilityScripts
{
    ...
    public class EventSystemSpawner : MonoBehaviour
    {
        void OnEnable()
        {
            ...
            Debug.LogError("PUN Demos are not compatible with the New Input System, unless you enable \"Both\" in: Edit > Project Settings > Character > Active Input Handling. Pausing App.");
            Debug.Break();
            return;
            #endif
